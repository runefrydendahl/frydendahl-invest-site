document.addEventListener('DOMContentLoaded', () => {
  const translations = {
    da: {
      ...
      sponsorEyebrow: 'Nyt initiativ',
      sponsorTitle: 'SponsorMatch er vores næste produktspor til klubber og lokale partnere.',
      sponsorCardTitle: 'SponsorMatch (under udvikling)',
      sponsorCardText:
        'Vi udforsker en platform, der forbinder lokale virksomheder og sportsklubber med bedre struktur omkring sponsorater, opfølgning, matchning og synlig effekt.',
      sponsorBadge: 'Konceptfase',
      sponsorBlock1Title: 'Hvad ideen skal løse',
      sponsorBlock1Item1: 'Give klubber et klart overblik over sponsorer, aftaler og perioder.',
      sponsorBlock1Item2: 'Hjælpe virksomheder med at finde relevante samarbejder lokalt.',
      sponsorBlock1Item3: 'Dokumentere værdi og aktivitet løbende for begge parter.',
      sponsorBlock2Title: 'Hvor vi er nu',
      sponsorBlock2Item1: 'Konceptet er i tidlig validering med input fra lokale cases.',
      sponsorBlock2Item2: 'Vi afklarer MVP-funktioner og bedste dataflow.',
      sponsorBlock2Item3: 'Interesserede kan komme med i de første dialoger.',
      sponsorCta1: 'Vis interesse for SponsorMatch',
      sponsorCta2: 'Se virksomhedsoplysninger',
      ...
      launchTitle: 'Start med Frydendahl Invest på frydendahlinvest.com.',
      launchText:
      ...
      launchCta1: 'Åbn frydendahlinvest.com',
      ...
      companyCvrLabel: 'CVR:',
      companyCvrValue: '30490908',
      companyVatLabel: 'Momsnummer:',
      companyVatValue: 'DK30490908',
      companyAddressLabel: 'Adresse:',
      companyAddressValue: 'Signalet 24',
      companyPostalLabel: 'Postnummer og by:',
      companyPostalValue: '4100 Ringsted',
      companyStartDateLabel: 'Startdato:',
      companyStartDateValue: '01.04.2007',
      companyTypeLabel: 'Virksomhedsform:',
      companyTypeValue: 'Anpartsselskab',
      companyStatusLabel: 'Status:',
      companyStatusValue: 'Normal',
      companyIndustryLabel: 'Branche:',
      companyIndustryValue: '642120 Ikke-finansielle holdingselskaber',
      companyFiscalYearLabel: 'Regnskabsar:',
      companyFiscalYearValue: '01.01 - 31.12',
      companyCountryLabel: 'Land:',
      companyCountryValue: 'Danmark',
    ...
    en: {
      ...
      sponsorEyebrow: 'New initiative',
      sponsorTitle: 'SponsorMatch is our next product track for clubs and local partners.',
      sponsorCardTitle: 'SponsorMatch (in development)',
      sponsorCardText:
        'We are exploring a platform that connects local companies and sports clubs with better structure around sponsorships, follow-up, matching and visible impact.',
      sponsorBadge: 'Concept phase',
      sponsorBlock1Title: 'What the idea should solve',
      sponsorBlock1Item1: 'Give clubs a clear overview of sponsors, agreements and periods.',
      sponsorBlock1Item2: 'Help companies find relevant local partnerships.',
      sponsorBlock1Item3: 'Document value and activity continuously for both parties.',
      sponsorBlock2Title: 'Where we are now',
      sponsorBlock2Item1: 'The concept is in early validation with input from local cases.',
      sponsorBlock2Item2: 'We are defining MVP functions and the best data flow.',
      sponsorBlock2Item3: 'Interested teams can join the first discovery conversations.',
      sponsorCta1: 'Show interest in SponsorMatch',
      sponsorCta2: 'See company details',
      ...
      launchTitle: 'Start with Frydendahl Invest on frydendahlinvest.com.',
      launchText:
      ...
      launchCta1: 'Open frydendahlinvest.com',
      ...
      companyCvrLabel: 'CVR no.:',
      companyCvrValue: '30490908',
      companyVatLabel: 'VAT no.:',
      companyVatValue: 'DK30490908',
      companyAddressLabel: 'Address:',
      companyAddressValue: 'Signalet 24',
      companyPostalLabel: 'Postal code and city:',
      companyPostalValue: '4100 Ringsted',
      companyStartDateLabel: 'Start date:',
      companyStartDateValue: '01.04.2007',
      companyTypeLabel: 'Company type:',
      companyTypeValue: 'Private limited company (ApS)',
      companyStatusLabel: 'Status:',
      companyStatusValue: 'Normal',
      companyIndustryLabel: 'Industry:',
      companyIndustryValue: '642120 Non-financial holding companies',
      companyFiscalYearLabel: 'Fiscal year:',
      companyFiscalYearValue: '01.01 - 31.12',
      companyCountryLabel: 'Country:',
      companyCountryValue: 'Denmark',
